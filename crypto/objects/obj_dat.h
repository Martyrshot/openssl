...
/* Serialized OID's */
static const unsigned char so[8009] = {
    ...
    0x2B,0xCE,0x0F,0x06,0x01,0x07,                 /* [ 7918] OBJ_sphincsharaka128srobust */
    0x2B,0xCE,0x0F,0x06,0x01,0x08,                 /* [ 7924] OBJ_p256_sphincsharaka128srobust */
    0x2B,0xCE,0x0F,0x06,0x01,0x09,                 /* [ 7930] OBJ_rsa3072_sphincsharaka128srobust */
    ...
    0x2B,0xCE,0x0F,0x06,0x04,0x07,                 /* [ 7954] OBJ_sphincssha256128srobust */
    0x2B,0xCE,0x0F,0x06,0x04,0x08,                 /* [ 7960] OBJ_p256_sphincssha256128srobust */
    0x2B,0xCE,0x0F,0x06,0x04,0x09,                 /* [ 7966] OBJ_rsa3072_sphincssha256128srobust */
    0x2B,0xCE,0x0F,0x06,0x07,0x01,                 /* [ 7972] OBJ_sphincsshake256128frobust */
    0x2B,0xCE,0x0F,0x06,0x07,0x02,                 /* [ 7978] OBJ_p256_sphincsshake256128frobust */
    0x2B,0xCE,0x0F,0x06,0x07,0x03,                 /* [ 7984] OBJ_rsa3072_sphincsshake256128frobust */
    0x2B,0xCE,0x0F,0x06,0x07,0x07,                 /* [ 7990] OBJ_sphincsshake256128srobust */
    0x2B,0xCE,0x0F,0x06,0x07,0x08,                 /* [ 7996] OBJ_p256_sphincsshake256128srobust */
    0x2B,0xCE,0x0F,0x06,0x07,0x09,                 /* [ 8002] OBJ_rsa3072_sphincsshake256128srobust */
};
...
static const ASN1_OBJECT nid_objs[NUM_NID] = {
    ...
    {"sphincsharaka128srobust", "sphincsharaka128srobust", NID_sphincsharaka128srobust, 6, &so[7918]},
    {"p256_sphincsharaka128srobust", "p256_sphincsharaka128srobust", NID_p256_sphincsharaka128srobust, 6, &so[7924]},
    {"rsa3072_sphincsharaka128srobust", "rsa3072_sphincsharaka128srobust", NID_rsa3072_sphincsharaka128srobust, 6, &so[7930]},
    ...
    {"sphincssha256128srobust", "sphincssha256128srobust", NID_sphincssha256128srobust, 6, &so[7954]},
    {"p256_sphincssha256128srobust", "p256_sphincssha256128srobust", NID_p256_sphincssha256128srobust, 6, &so[7960]},
    {"rsa3072_sphincssha256128srobust", "rsa3072_sphincssha256128srobust", NID_rsa3072_sphincssha256128srobust, 6, &so[7966]},
    {"sphincsshake256128frobust", "sphincsshake256128frobust", NID_sphincsshake256128frobust, 6, &so[7972]},
    {"p256_sphincsshake256128frobust", "p256_sphincsshake256128frobust", NID_p256_sphincsshake256128frobust, 6, &so[7978]},
    {"rsa3072_sphincsshake256128frobust", "rsa3072_sphincsshake256128frobust", NID_rsa3072_sphincsshake256128frobust, 6, &so[7984]},
    {"sphincsshake256128srobust", "sphincsshake256128srobust", NID_sphincsshake256128srobust, 6, &so[7990]},
    {"p256_sphincsshake256128srobust", "p256_sphincsshake256128srobust", NID_p256_sphincsshake256128srobust, 6, &so[7996]},
    {"rsa3072_sphincsshake256128srobust", "rsa3072_sphincsshake256128srobust", NID_rsa3072_sphincsshake256128srobust, 6, &so[8002]},
};
...
static const unsigned int sn_objs[NUM_SN] = {
    ...
    1141,    /* "oscca" */
     ...
     876,    /* "owner" */
    1259,    /* "p256_bikel1" */
    1274,    /* "p256_dilithium2" */
    1281,    /* "p256_dilithium2_aes" */
    1288,    /* "p256_falcon512" */
    1235,    /* "p256_frodo640aes" */
    1236,    /* "p256_frodo640shake" */
    1264,    /* "p256_hqc128" */
    1241,    /* "p256_kyber512" */
    1261,    /* "p256_kyber90s512" */
    1248,    /* "p256_lightsaber" */
    1244,    /* "p256_ntru_hps2048509" */
    1267,    /* "p256_ntrulpr653" */
    1268,    /* "p256_ntrulpr761" */
    1251,    /* "p256_sidhp434" */
    1252,    /* "p256_sidhp503" */
    1255,    /* "p256_sikep434" */
    1256,    /* "p256_sikep503" */
    1270,    /* "p256_sntrup653" */
    1271,    /* "p256_sntrup761" */
    1293,    /* "p256_sphincsharaka128frobust" */
    1296,    /* "p256_sphincsharaka128srobust" */
    1299,    /* "p256_sphincssha256128frobust" */
    1302,    /* "p256_sphincssha256128srobust" */
    1305,    /* "p256_sphincsshake256128frobust" */
    1308,    /* "p256_sphincsshake256128srobust" */
    1260,    /* "p384_bikel3" */
    1277,    /* "p384_dilithium3" */
    1284,    /* "p384_dilithium3_aes" */
    1237,    /* "p384_frodo976aes" */
    1238,    /* "p384_frodo976shake" */
    1265,    /* "p384_hqc192" */
    1242,    /* "p384_kyber768" */
    1262,    /* "p384_kyber90s768" */
    1245,    /* "p384_ntru_hps2048677" */
    1247,    /* "p384_ntru_hrss701" */
    1269,    /* "p384_ntrulpr857" */
    1249,    /* "p384_saber" */
    1253,    /* "p384_sidhp610" */
    1257,    /* "p384_sikep610" */
    1272,    /* "p384_sntrup857" */
    1279,    /* "p521_dilithium5" */
    1286,    /* "p521_dilithium5_aes" */
    1291,    /* "p521_falcon1024" */
    1250,    /* "p521_firesaber" */
    1239,    /* "p521_frodo1344aes" */
    1240,    /* "p521_frodo1344shake" */
    1266,    /* "p521_hqc256" */
    1243,    /* "p521_kyber1024" */
    1263,    /* "p521_kyber90s1024" */
    1246,    /* "p521_ntru_hps4096821" */
    1254,    /* "p521_sidhp751" */
    1258,    /* "p521_sikep751" */
    ...
    1033,    /* "pkInitKDC" */
     ...
     448,    /* "room" */
     463,    /* "roomNumber" */
    1275,    /* "rsa3072_dilithium2" */
    1282,    /* "rsa3072_dilithium2_aes" */
    1289,    /* "rsa3072_falcon512" */
    1294,    /* "rsa3072_sphincsharaka128frobust" */
    1297,    /* "rsa3072_sphincsharaka128srobust" */
    1300,    /* "rsa3072_sphincssha256128frobust" */
    1303,    /* "rsa3072_sphincssha256128srobust" */
    1306,    /* "rsa3072_sphincsshake256128frobust" */
    1309,    /* "rsa3072_sphincsshake256128srobust" */
       6,    /* "rsaEncryption" */
    ...
    1232,    /* "sntrup761" */
    1233,    /* "sntrup857" */
    1292,    /* "sphincsharaka128frobust" */
    1295,    /* "sphincsharaka128srobust" */
    1298,    /* "sphincssha256128frobust" */
    1301,    /* "sphincssha256128srobust" */
    1304,    /* "sphincsshake256128frobust" */
    1307,    /* "sphincsshake256128srobust" */
     660,    /* "street" */
      85,    /* "subjectAltName" */
...
static const unsigned int obj_objs[NUM_OBJ] = {
    ...
    1287,    /* OBJ_falcon512                    1 3 9999 3 1 */
    1288,    /* OBJ_p256_falcon512               1 3 9999 3 2 */
    1289,    /* OBJ_rsa3072_falcon512            1 3 9999 3 3 */
    1290,    /* OBJ_falcon1024                   1 3 9999 3 4 */
    1291,    /* OBJ_p521_falcon1024              1 3 9999 3 5 */
    ...
    1274,    /* OBJ_p256_dilithium2              1 3 9999 2 7 1 */
    1275,    /* OBJ_rsa3072_dilithium2           1 3 9999 2 7 2 */
    1277,    /* OBJ_p384_dilithium3              1 3 9999 2 7 3 */
    1279,    /* OBJ_p521_dilithium5              1 3 9999 2 7 4 */
    1281,    /* OBJ_p256_dilithium2_aes          1 3 9999 2 11 1 */
    1282,    /* OBJ_rsa3072_dilithium2_aes       1 3 9999 2 11 2 */
    1284,    /* OBJ_p384_dilithium3_aes          1 3 9999 2 11 3 */
    1286,    /* OBJ_p521_dilithium5_aes          1 3 9999 2 11 4 */
    1292,    /* OBJ_sphincsharaka128frobust      1 3 9999 6 1 1 */
    1293,    /* OBJ_p256_sphincsharaka128frobust 1 3 9999 6 1 2 */
    1294,    /* OBJ_rsa3072_sphincsharaka128frobust 1 3 9999 6 1 3 */
    1295,    /* OBJ_sphincsharaka128srobust      1 3 9999 6 1 7 */
    1296,    /* OBJ_p256_sphincsharaka128srobust 1 3 9999 6 1 8 */
    1297,    /* OBJ_rsa3072_sphincsharaka128srobust 1 3 9999 6 1 9 */
    1298,    /* OBJ_sphincssha256128frobust      1 3 9999 6 4 1 */
    1299,    /* OBJ_p256_sphincssha256128frobust 1 3 9999 6 4 2 */
    1300,    /* OBJ_rsa3072_sphincssha256128frobust 1 3 9999 6 4 3 */
    1301,    /* OBJ_sphincssha256128srobust      1 3 9999 6 4 7 */
    1302,    /* OBJ_p256_sphincssha256128srobust 1 3 9999 6 4 8 */
    1303,    /* OBJ_rsa3072_sphincssha256128srobust 1 3 9999 6 4 9 */
    1304,    /* OBJ_sphincsshake256128frobust    1 3 9999 6 7 1 */
    1305,    /* OBJ_p256_sphincsshake256128frobust 1 3 9999 6 7 2 */
    1306,    /* OBJ_rsa3072_sphincsshake256128frobust 1 3 9999 6 7 3 */
    1307,    /* OBJ_sphincsshake256128srobust    1 3 9999 6 7 7 */
    1308,    /* OBJ_p256_sphincsshake256128srobust 1 3 9999 6 7 8 */
    1309,    /* OBJ_rsa3072_sphincsshake256128srobust 1 3 9999 6 7 9 */
    ...
    1273,    /* OBJ_dilithium2                   1 3 6 1 4 1 2 267 7 4 4 */
    1276,    /* OBJ_dilithium3                   1 3 6 1 4 1 2 267 7 6 5 */
    1278,    /* OBJ_dilithium5                   1 3 6 1 4 1 2 267 7 8 7 */
    1280,    /* OBJ_dilithium2_aes               1 3 6 1 4 1 2 267 11 4 4 */
    1283,    /* OBJ_dilithium3_aes               1 3 6 1 4 1 2 267 11 6 5 */
    1285,    /* OBJ_dilithium5_aes               1 3 6 1 4 1 2 267 11 8 7 */
