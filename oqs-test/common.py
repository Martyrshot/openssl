...
##### OQS_TEMPLATE_FRAGMENT_SIG_ALGS_START
    ...
    'dilithium2','dilithium3','dilithium5','dilithium2_aes','dilithium3_aes','dilithium5_aes','falcon512','falcon1024','sphincsharaka128frobust','sphincsharaka128srobust','sphincssha256128frobust','sphincssha256128srobust','sphincsshake256128frobust','sphincsshake256128srobust',
    # post-quantum + classical signatures
    'p256_dilithium2','rsa3072_dilithium2','p384_dilithium3','p521_dilithium5','p256_dilithium2_aes','rsa3072_dilithium2_aes','p384_dilithium3_aes','p521_dilithium5_aes','p256_falcon512','rsa3072_falcon512','p521_falcon1024','p256_sphincsharaka128frobust','rsa3072_sphincsharaka128frobust','p256_sphincsharaka128srobust','rsa3072_sphincsharaka128srobust','p256_sphincssha256128frobust','rsa3072_sphincssha256128frobust','p256_sphincssha256128srobust','rsa3072_sphincssha256128srobust','p256_sphincsshake256128frobust','rsa3072_sphincsshake256128frobust','p256_sphincsshake256128srobust','rsa3072_sphincsshake256128srobust',
